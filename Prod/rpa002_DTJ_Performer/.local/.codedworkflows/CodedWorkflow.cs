...
namespace rpa002_DTJ_Performer
{
    ...
    {
        private Lazy<global::rpa002_DTJ_Performer.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::rpa002_DTJ_Performer.WorkflowRunnerService>(() => new global::rpa002_DTJ_Performer.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::rpa002_DTJ_Performer.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;

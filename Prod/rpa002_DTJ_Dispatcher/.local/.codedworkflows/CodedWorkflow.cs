...
namespace rpa002_DTJ_Dispatcher
{
    ...
    {
        private Lazy<global::rpa002_DTJ_Dispatcher.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::rpa002_DTJ_Dispatcher.WorkflowRunnerService>(() => new global::rpa002_DTJ_Dispatcher.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::rpa002_DTJ_Dispatcher.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
